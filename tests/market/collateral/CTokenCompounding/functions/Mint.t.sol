...
contract CTokenCompoundingMintTest is TestBaseCTokenCompounding {
    event Transfer(address indexed from, address indexed to, uint256 amount);

    function test_cTokenCompoundingMint_fail_whenTransferZeroAmount() public {
        vm.expectRevert(
    ...
    function test_cTokenCompoundingMint_fail_whenMintIsNotAllowed() public {
    ...
    function test_cTokenCompoundingMint_success() public {
