...
import "contracts/market/InterestRateModel/DAIInterestRateModelV3.sol";
...
contract TestDAIInterestRateModelV3 is TestBase {
    ...
    function setUp() public {
        ...
        interestRateModel = address(new DAIInterestRateModelV3(1e17, 5e17, pot, jug, admin));
