...
import "contracts/compound/WhitePaperInterestRateModel.sol";
...
contract TestWhitePaperInterestRateModel is DSTestPlus {
    ...
    function setUp() public {
        ...
        interestRateModel = address(new WhitePaperInterestRateModel(1e17, 1e17));
