...
contract CVE is OFTV2 {
    ...
    constructor(string memory _name, 
                ...
                uint256 initialTokenMint) OFTV2(_name, _symbol, _sharedDecimals, _lzEndpoint, _centralRegistry) {
    ...
    modifier onlyVotingHub() {
        require(msg.sender == centralRegistry.votingHub(), "CVE: UNAUTHORIZED");
    ...
    */
    function mintGaugeEmissions(uint256 _gaugeEmissions) external onlyVotingHub {
        _mint(msg.sender, (_gaugeEmissions * centralRegistry.lockBoostValue()) / DENOMINATOR);
    }
    ...
    */
    function mintTreasuryTokens(uint256 _tokensToMint) external onlyDaoManager {
        require(DAOTreasuryAllocation >= DAOTreasuryTokensMinted + _tokensToMint, "CVE: insufficient token allocation");
    ...
    */
    function mintCallOptionTokens(uint256 _tokensToMint) external onlyDaoManager {
        require(callOptionAllocation >= callOptionTokensMinted + _tokensToMint, "CVE: insufficient token allocation");
    ...
    */
    function mintTeamTokens() external onlyTeam {
        ...
        uint256 _tokensToMint = (monthsSinceTGE * TeamAllocationPerMonth) - TeamAllocationTokensMinted;
