...
contract JumpRateModelV2 {
    ...
    /// @param multiplierPerYear The rate of increase in interest rate wrt
    ///                          utilization (scaled by BASE)
    /// @param jumpMultiplierPerYear The multiplierPerBlock after hitting
    ///                              a specified utilization point
    /// @param kink_ The utilization point at which the jump multiplier
    ///              is applied
    /// @param owner_ The address of the owner
    ///               i.e. the Timelock contract (which has the ability
    ...
    ///         (only callable by owner, i.e. Timelock)
    /// @param baseRatePerYear The approximate target base APR,
    ///                        as a mantissa (scaled by BASE)
    /// @param multiplierPerYear The rate of increase in interest rate wrt
    ///                          utilization (scaled by BASE)
    ...
    /// @return The supply rate percentage per block as a mantissa
    ///         (scaled by BASE)
    ...
    /// @notice Internal function to update the parameters
