...
//         if (msg.sender != guardian || comp.getPriorVotes(proposal.proposer, sub256(block.number, 1)) >= proposalThreshold()) {
//             revert ProposerAboveThreshold();
//         }
...
//         if (proposalCount < proposalId && proposalId <= 0) {
